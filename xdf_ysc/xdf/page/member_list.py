class MemberList:
    ...
    def member_list(self):
        ...
        for i in range(len(member_list1)):
            # 取默认的列表中姓名
            member_name1 = self.driver.find_element_by_xpath(
                '//*[@id="app"]/div/div[2]/div[1]/div[3]/table/tbody/tr[' + str(i + 1) + ']/td[2]/div').text
            # 取默认的列表中手机号
            member_mobile1 = self.driver.find_element_by_xpath(
                '//*[@id="app"]/div/div[2]/div[1]/div[3]/table/tbody/tr[' + str(i + 1) + ']/td[3]/div').text
            # 输入姓名搜索
            self.driver.find_element_by_xpath('//*[@id="app"]/div/div[1]/div[1]/div/div[1]/div/input').send_keys(
                member_name1)
            # 点击搜索按钮
            ...
            for j in range(len(member_list2)):
                # 获取查询后的列表中的手机号码
                member_mobile2 = self.driver.find_element_by_xpath(
                    '//*[@id="app"]/div/div[2]/div[1]/div[3]/table/tbody/tr[' + str(j + 1) + ']/td[3]/div').text
